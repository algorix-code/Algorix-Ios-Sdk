...
class AlgorixInterstitialVC: BaseUIViewController {
    ...
    @objc func loadAd(){
        ...
        interstitialAd.loadAd(adUnitId: AdConfig.Alx_Interstitial_Video_Ad_Id)
    }
...
extension AlgorixInterstitialVC:AlxInterstitialAdDelegate {
