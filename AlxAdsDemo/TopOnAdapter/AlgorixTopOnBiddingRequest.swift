//
//  AlgorixTopOnBiddingRequest.swift
//  AlxAdsDemo
//
...
@objc(AlgorixTopOnBiddingRequest)
public class AlgorixTopOnBiddingRequest:NSObject {
...
//    }
    ...
    deinit {
        print("AlgorixTopOnBiddingRequest: deinit")
    }
