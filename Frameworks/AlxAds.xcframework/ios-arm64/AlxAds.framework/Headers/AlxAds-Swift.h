...
enum AlxLogLevel : NSInteger;

SWIFT_CLASS_NAMED("AlxLog")
@interface AlxLog : NSObject
+ (void)v:(enum AlxLogLevel)level msg:(id _Nonnull)msg filename:(NSString * _Nonnull)filename line:(NSInteger)line function:(NSString * _Nonnull)function;
+ (void)i:(enum AlxLogLevel)level msg:(id _Nonnull)msg filename:(NSString * _Nonnull)filename line:(NSInteger)line function:(NSString * _Nonnull)function;
+ (void)d:(enum AlxLogLevel)level msg:(id _Nonnull)msg filename:(NSString * _Nonnull)filename line:(NSInteger)line function:(NSString * _Nonnull)function;
+ (void)w:(enum AlxLogLevel)level msg:(id _Nonnull)msg filename:(NSString * _Nonnull)filename line:(NSInteger)line function:(NSString * _Nonnull)function;
+ (void)e:(enum AlxLogLevel)level msg:(id _Nonnull)msg filename:(NSString * _Nonnull)filename line:(NSInteger)line function:(NSString * _Nonnull)function;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

/// 打印日志级别
typedef SWIFT_ENUM(NSInteger, AlxLogLevel, open) {
...
SWIFT_CLASS_NAMED("AlxOmidBean")
@interface AlxOmidBean : NSObject <NSCoding>
@property (nonatomic, readonly, copy) NSString * _Nonnull key;
@property (nonatomic, readonly, copy) NSString * _Nonnull params;
@property (nonatomic, readonly, copy) NSString * _Nonnull url;
- (nonnull instancetype)initWithKey:(NSString * _Nonnull)key params:(NSString * _Nonnull)params url:(NSString * _Nonnull)url OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS_NAMED("OmConfig")
@interface OmConfig : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull Partner_Name;)
+ (NSString * _Nonnull)Partner_Name SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull Vendor_Key;)
+ (NSString * _Nonnull)Vendor_Key SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
